...
public class ELTC_067Tests {
	...
	public void setUp() throws Exception {
		...
		loginPOM = new LoginPOM(driver);		eltc_067POM= new ELTC_067POM(driver);
		...
		screenShot.captureScreenShot("After login to application");
	...
	public void loginDBTest(String fieldsName, String firstName, String lastName, String eMail, String phone,String login, String password) {
		...
		screenShot.captureScreenShot("After adding user");
